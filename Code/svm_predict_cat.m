...
[sparseTestMatrix, testCategory] = readMatrixCat('SVMinputTest.tsv');
...
plot(prcurve(:,2),prcurve(:,1),'-o');
title('precision-recall (apply score + job description )');
xlabel('reall');
ylabel('precision');
